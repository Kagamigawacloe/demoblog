...
// 白名单
const whiteList = ['/systemSetup', '/linkManager', "/userManager", "/classifyManager",'/personSetup', "/backstage", '/commentManager', "/articleManager", "/addArticle", "/backstageHome",];
const adminList = ['/systemSetup', '/linkManager', "/userManager", "/classifyManager",];
